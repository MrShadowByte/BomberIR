...
print(             " ██      ██    ██    ██   ██          ██     ██        █████       ██   ██   ██")
print(             " ██       ███████████     ███████      ███████ \n" + Fore.RESET)
print(Fore.GREEN +  " Name App :      Shadow_Bomb   |  App Version : 1.1.1   | More : 100 Api .")
print(Fore.WHITE +  " Programmer :   MR_ShadowByte  |      For fun :D        | For free" + Fore.BLACK)
print(Fore.RED +    " WebSite : www.pixelshop24.com | GitHub : Mr ShadowByte | Telegram : --")
...
[number:0999*******]---> : '''+ Fore.RESET)
    ...
    print("Made By ShadowByte")
    print("GitHub : https://github.com/MrshadowByte , Telegram : -- , WebSite : www.pixelshop24.com")
    print("Exiting ...")
